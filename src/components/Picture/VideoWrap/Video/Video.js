...
const Video = (props) => {
    ...
    return (
        <div className="video">
            ...
            <iframe className='videoPlayer' src={props.path} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen>
